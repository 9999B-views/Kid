...
public class TextRecognition {
    ...
    public static void saveTextRecogResult(Program program, Bitmap[] bitmapImages){
        resultList = new ArrayList<>();
        runTextRecognition(program, bitmapImages);
    }

    private static void runTextRecognition(Program program, Bitmap[] bitmapImages) {
                    ...
                    .addOnSuccessListener(
                            new OnSuccessListener<FirebaseVisionText>() {
                                ...
                                public void onSuccess(FirebaseVisionText texts) {
                                    processTextRecognitionResult(program, texts);
                                }
                            })
    ...
    private static void processTextRecognitionResult(Program program, FirebaseVisionText texts) {
